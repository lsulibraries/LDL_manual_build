#!/bin/bash
#Configuring Logging
sudo cp /mnt/hgfs/shared/configs/blazegraph/log4j.properties /opt/blazegraph/conf/
...
sudo cp /mnt/hgfs/shared/configs/blazegraph/RWStore.properties /opt/blazegraph/conf
sudo chown tomcat:tomcat /opt/blazegraph/conf/RWStore.properties
sudo chmod 644 /opt/blazegraph/conf/RWStore.properties
sudo cp /mnt/hgfs/shared/configs/blazegraph/blazegraph.properties /opt/blazegraph/conf
...
sudo cp /mnt/hgfs/shared/configs/blazegraph/inference.nt /opt/blazegraph/conf
