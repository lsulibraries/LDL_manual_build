#!/bin/bash
sudo cp /mnt/hgfs/shared/configs/crayfish_configs/Houdini/config /opt/crayfish/Houdini
...
sudo cp /mnt/hgfs/shared/configs/crayfish_configs/Homarus /opt/crayfish/Homarus
...
sudo cp /mnt/hgfs/shared/configs/crayfish_configs/Hypercube /opt/crayfish/Hypercube
...
sudo cp /mnt/hgfs/shared/configs/crayfish_configs/Milliner /opt/crayfish/Milliner
mkdir -p /opt/crayfish/Hypercube/var/cache/dev
sudo chown -R www-data:www-data /opt/crayfish/Milliner
sudo chmod -R 755 /opt/crayfish/Milliner

sudo cp /mnt/hgfs/shared/configs/crayfish_configs/CrayFits /opt/crayfish/CrayFits
...
sudo cp /mnt/hgfs/shared/configs/crayfish_configs/Recast /opt/crayfish/Recast
